/*
 * GBWUI — Calibration wizard (placeholder)
 *
 * Full design per DESIGN.md §5.6 (3 steps):
 *   Step 1 — Remove weight, show live reading, Continue
 *   Step 2 — Place known weight, enter value, Continue
 *   Step 3 — Confirm factor, Discard / Save
 */
